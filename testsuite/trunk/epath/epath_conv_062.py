...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{BACK_PANEL_BOARD,28}{PROCESSOR,36}")
        ...
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_BACK_PANEL_BOARD,False)
    
        self.assertEqual (ep.Entry[1].EntityLocation != 28,False)
