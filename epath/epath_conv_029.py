...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{SBC_BLADE,34}{PERIPHERAL_BAY,8}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_PERIPHERAL_BAY,False) 
        #print"  Error! Testcase failed. Line=%d\n", __LINE__
        ...
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_SBC_BLADE,False) 
        #print"  Error! Testcase failed. Line=%d\n", __LINE__
        #print"  Received=%d; Expected=%d\n", ep.Entry[1].EntityType, SAHPI_ENT_SBC_BLADE
        
        self.assertEqual (ep.Entry[1].EntityLocation != 34,False) 
        #print"  Error! Testcase failed. Line=%d\n", __LINE__
