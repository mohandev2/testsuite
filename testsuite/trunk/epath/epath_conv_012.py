...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{UNSPECIFIED,57}{SHELF_MANAGER,95}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_SHELF_MANAGER,False) 
        #print "  Error! Testcase failed. Line=%d\n", __LINE__
        #print "  Received=%d; Expected=%d\n", ep.Entry[0].EntityType, SAHPI_ENT_SHELF_MANAGER

        self.assertEqual (ep.Entry[0].EntityLocation != 95,False)
        #print "  Error! Testcase failed. Line=%d\n", __LINE__
