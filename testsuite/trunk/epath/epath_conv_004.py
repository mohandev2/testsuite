...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{MEMORY_MODULE,95}{SYS_MGMNT_MODULE,93}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 93,False) 
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_MEMORY_MODULE,False) 
        
        self.assertEqual (ep.Entry[1].EntityLocation != 95,False) 
