...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{PROCESSOR_BOARD,43}{OPERATING_SYSTEM,51}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 51,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_PROCESSOR_BOARD,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 43,False)
