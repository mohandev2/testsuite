...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{SUBBOARD_CARRIER_BLADE,91}{SWITCH,44}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 44,False) 
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_SUBBOARD_CARRIER_BLADE,False) 
