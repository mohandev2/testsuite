...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{OEM_SYSINT_SPECIFIC,6}{BOARD_SET_SPECIFIC,30}")
        ep=SaHpiEntityPathT()
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 30,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_OEM_SYSINT_SPECIFIC,False)
