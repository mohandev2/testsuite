...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{DISK_DRIVE,81}{BACK_PANEL_BOARD,87}")
        ...
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_DISK_DRIVE,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 81,False)
