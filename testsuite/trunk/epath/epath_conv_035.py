...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{ALARM_MANAGER,3}{PROCESSOR_MODULE,5}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_PROCESSOR_MODULE,False) 
        #print"  Error! Testcase failed. Line=%d\n", __LINE__
        ...
        self.assertEqual (ep.Entry[1].EntityLocation != 3,False)
        #print"  Error! Testcase failed. Line=%d\n", __LINE__
