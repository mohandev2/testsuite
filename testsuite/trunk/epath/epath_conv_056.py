...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{INTERCONNECT,65}{RACK_MOUNTED_SERVER,76}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_RACK_MOUNTED_SERVER,False)
    
        self.assertEqual (ep.Entry[0].EntityLocation != 76,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_INTERCONNECT,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 65,False) 
