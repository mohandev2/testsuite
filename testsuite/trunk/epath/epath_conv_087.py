...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{SYSTEM_BUS,29}{SYS_MGMNT_SOFTWARE,1}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_SYS_MGMNT_SOFTWARE,False)
        
        self.assertEqual (ep.Entry[0].EntityLocation != 1,False)
    
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_SYSTEM_BUS,False)
    
        self.assertEqual (ep.Entry[1].EntityLocation != 29,False)
