...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{ADD_IN_CARD,43}{CHASSIS_BACK_PANEL_BOARD,83}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 83,False) 
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_ADD_IN_CARD,False)
