...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{PERIPHERAL_BAY,12}{DISK_BAY,62}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_DISK_BAY,False) 
        #print "  Error! Testcase failed. Line=%d\n", __LINE__
        ...
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_PERIPHERAL_BAY,False) 
        #print "  Error! Testcase failed. Line=%d\n", __LINE__
