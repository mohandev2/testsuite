...
class TestSequence(unittest.TestCase):
    """
    Starts with an RPTable of 10 resources, adds 5 annunciator rdr
    ...
    def runTest(self):
        ...
        for ann in annunciators:
            self.assertEqual(oh_add_rdr(rptable, SAHPI_FIRST_ENTRY, ann, None,0), 0)
            records.append(ann)
