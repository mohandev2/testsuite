...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{POWER_DISTRIBUTION_UNIT,45}{CHASSIS_SPECIFIC,26}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 26,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_POWER_DISTRIBUTION_UNIT,False)
