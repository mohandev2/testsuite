...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{ALARM_MANAGER,99}{POWER_DISTRIBUTION_UNIT,54}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_POWER_DISTRIBUTION_UNIT,False)
        
        self.assertEqual (ep.Entry[0].EntityLocation != 54,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_ALARM_MANAGER,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 99,False)
