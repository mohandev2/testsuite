...
class TestSequence(unittest.TestCase):
    ...
    def runTest(self):
        ...
        self.assertEqual ((ep.Entry[0].EntityLocation != 100) or
           ...
           (ep.Entry[9].EntityType != SAHPI_ENT_SUBRACK),True) 
