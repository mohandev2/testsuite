...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{POWER_MODULE,9}{SBC_BLADE,46}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_SBC_BLADE,False) 
        
        self.assertEqual  (ep.Entry[0].EntityLocation != 46,False) 
