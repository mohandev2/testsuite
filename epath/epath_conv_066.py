...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{SYS_EXPANSION_BOARD,24}{POWER_UNIT,49}")
        ...
        self.assertEqual (ep.Entry[0].EntityType != SAHPI_ENT_POWER_UNIT,False)
    
        self.assertEqual (ep.Entry[0].EntityLocation != 49,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_SYS_EXPANSION_BOARD,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 24,False)
