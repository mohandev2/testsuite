...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{SYSTEM_BOARD,83}{OTHER_SYSTEM_BOARD,25}")
        ...
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_SYSTEM_BOARD,False)
        
        self.assertEqual (ep.Entry[1].EntityLocation != 83,False)
