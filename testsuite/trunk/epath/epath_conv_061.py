...
class TestSequence(unittest.TestCase):
    ...
    """
    def runTest(self):
        test_string = ("{IO_SUBBOARD,39}{SPEC_PROC_BLADE,78}")
        ...
        self.assertEqual (ep.Entry[0].EntityLocation != 78,False)
        
        self.assertEqual (ep.Entry[1].EntityType != SAHPI_ENT_IO_SUBBOARD,False)
